...
- **Diagrams render inline.** Every ipmt fence is paired with a rendered SVG below it (auto-generated by [`md-embed`](https://github.com/infinite-pm/ipm-tools/tree/main/cmd/md-embed)). PNG diagrams use `<img height|width="...">` so they fit the column.
